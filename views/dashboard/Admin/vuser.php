        ...
        <div class="bg-white/10 backdrop-blur-md rounded-xl p-4 md:p-6 mb-8">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div>
                    ...
                    <p class="text-white/80 text-lg">Total Clients: <?php echo count($users); ?></p>
                </div>
                    ...
                    <?php foreach($users as $user ): ?>
                        ...
                        <tr class="hover:bg-white/5">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="<?php echo "?edit=" . $user['account_id'] ?>" class="text-indigo-300 hover:text-indigo-100 mr-3">Edit</a>
